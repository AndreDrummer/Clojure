...
; Deu erro porque não tem um critério de parada

; Agora vou implementar um criterio de parada
(defn conta
  [total-ate-agora elementos]
  (if (next elementos)
...
; Esse exemplo abaixo mostra algo parecido com a sobrecarga de métodos.
(defn minha-funcao
